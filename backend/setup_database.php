...
$schemaStatements = [
    ...
    "CREATE TABLE IF NOT EXISTS `orders` (
        ...
        `mpesa_merchant_request_id` VARCHAR(120) DEFAULT NULL,
        `mpesa_receipt_number` VARCHAR(120) DEFAULT NULL,
        `mpesa_result_code` VARCHAR(20) DEFAULT NULL,
        `mpesa_result_desc` TEXT DEFAULT NULL,
        `mpesa_status` VARCHAR(30) DEFAULT NULL,
        `mpesa_requested_amount` DECIMAL(10,2) DEFAULT NULL,
        `mpesa_raw_callback` LONGTEXT DEFAULT NULL,
        ...
        KEY `idx_orders_mpesa_checkout_request_id` (`mpesa_checkout_request_id`),
